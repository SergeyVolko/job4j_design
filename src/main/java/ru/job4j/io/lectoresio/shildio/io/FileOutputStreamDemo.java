...
//Продемонстрировать применение класса FileOutputStrearn.
...
public class FileOutputStreamDemo {
    public static void main(String[] args) {
        ...
        try {
            f0 = new FileOutputStream("src/main/java/ru/job4j/io/lectoresio/shildio/io/file1.txt");
            f1 = new FileOutputStream("src/main/java/ru/job4j/io/lectoresio/shildio/io/file2.txt");
            f2 = new FileOutputStream("src/main/java/ru/job4j/io/lectoresio/shildio/io/file3.txt");
